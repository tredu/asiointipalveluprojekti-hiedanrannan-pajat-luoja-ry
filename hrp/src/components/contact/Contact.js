            ...
            <div className="contact-container">
                <div className="container-fluid text-white">
                    ...
                    {/* <div className="col-sm-3 col-md-3"></div> */}
                        <div className="col-sm-5 col-md-4" id="about">
                        ...
                        <div className="col-sm-5 col-md-4" id="about">
                            ...
                            <p className="text-center">Jos vuokralaiseksi hakeminen kiinnostaa, niin ota yhteyttä yllä olevaan sähköpostiosoitteeseen.</p>
                            <SocialIcon className="facebook mb-2" url="http://facebook.com/hiedanrannan.paja" />
                            <SocialIcon className="instagram mb-2" url="https://www.instagram.com/hiedanrannan_paja/" />
                        </div>
                    </div>
                </div>
            </div>
